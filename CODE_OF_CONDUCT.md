...
We as contributors and maintainers pledge to make participation in the Kratos
...
a private channel with the maintainers before sharing details publicly. For
security-sensitive reports, follow the process in [SECURITY.md](SECURITY.md).
For general conduct concerns, open a discreet issue requesting maintainer
contact without posting personal details.
